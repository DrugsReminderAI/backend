...
TOOLS = [
    ...
    },
    {
        ...
        "function": {
            ...
            "description": "Возвращает текущее время по московскому часовому поясу в формате HH:MM. Используется для ориентации по локальному времени пользователя, если не указан часовой пояс явно.",
            "parameters": {
                "type": "object",
                "properties": {},
                "required": [],
