...
TOOLS = [
    ...
    },
    {
        ...
        "function": {
            ...
            "description": (
                ...
                "Ожидает словарь, где ключи — время в формате HH:MM, а значения — список препаратов.\n"
                'Пример: {"07:00": ["магний"], "21:00": ["мелатонин"]}'
            ),
            "parameters": {
                "type": "object",
                "properties": {
    ...
    },
    {
        ...
        "function": {
            ...
            "description": (
                "Обновляет все напоминания пользователя, очищая старые и добавляя новые из YAML. "
                "Эта функция вызывается **только один раз** после обновления расписания. "
                "Не вызывай её на каждое лекарство — она работает сразу со всем YAML-файлом."
            ),
            "parameters": {
                "type": "object",
                "properties": {},
